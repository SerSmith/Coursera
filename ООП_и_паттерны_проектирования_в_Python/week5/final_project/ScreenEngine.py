...
class ScreenHandle(pygame.Surface):
    ...
    def calculate(self):
        hero_position_x, hero_position_y = self.engine.hero.position
        screen_size_x, screen_size_y = self.get_size()
        screen_size_x /= self.engine.sprite_size
        screen_size_y /= self.engine.sprite_size

        min_x = int(max(0, hero_position_x - screen_size_x + 3))
        min_y = int(max(0, hero_position_y - screen_size_y + 3))
        return (min_x, min_y)
